    ...
    return (
        ...
        >
            ...
            <div className='text-center py-36 space-y-4'>
                ...
                <button onClick={() => handeladdcoin(100000000)} className=' bg-[#E7FE29] px-4 py-2 text-black rounded-md  border-blue-400 shadow-lg shadow-cyan-500/100'>Claim Free Credit</button>
            </div>
